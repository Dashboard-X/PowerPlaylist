...
{
    public class SimpleAlbumVertical : PhotoBase
    {
        ...
        private void GenerateContent()
        {
            ...
            double HeightDifference = (Height - 10.0) / 2;
            ...
            MainGrid.ColumnDefinitions.Add(new ColumnDefinition() { Width = new GridLength(75, GridUnitType.Pixel) });

            Scroller.HorizontalScrollBarVisibility = ScrollBarVisibility.Hidden;
            Scroller.VerticalScrollBarVisibility = ScrollBarVisibility.Auto;
            Scroller.SetValue(Grid.ColumnProperty, 1);

            ImageItems = new StackPanel();
            ImageItems.Orientation = Orientation.Vertical;
            ...
            FirstImage.Margin = new Thickness(5.0);
            SecondImage.Margin = new Thickness(5.0);
